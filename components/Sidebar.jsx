            ...
            <div className="flex items-center gap-3 p-2 rounded-lg hover:bg-[var(--bg-secondary)] transition-colors">
              ...
              <div className="flex-1 min-w-0 hidden xl:block">
                <div className="flex items-center gap-1.5">
                  <p className="font-medium text-[14px] text-[var(--text)] truncate">{session.user.name}</p>
                ...
                <p className="text-[var(--text-secondary)] text-[13px] truncate">@{session.user.username}</p>
              </div>
              <button
                onClick={() => signOut()}
                className="hidden xl:block p-1.5 rounded-lg text-[var(--text-secondary)] hover:text-red-500 hover:bg-red-50 transition-colors"
              >
